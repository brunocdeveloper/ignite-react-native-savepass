...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: any) {
    ...
    const parseData = (dataStorage && JSON.parse(dataStorage)) || [];
    const newItem = [...parseData, newLoginData];
    await AsyncStorage.setItem(dataKey, JSON.stringify(newItem));
    navigate("Home");
  }
      ...
      <Container>
        <Form>
          <Input
            ...
            name="service_name"
            error={errors.service_name && (errors.service_name.message as any)}
            control={control}
